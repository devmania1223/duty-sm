...
erdpy --verbose contract deploy --chain="D" --bytecode "output/reward-handler.wasm" --pem="../../wallet-owner.pem" --gas-limit=600000000 --proxy="https://devnet-gateway.elrond.com" --recall-nonce --send --arguments "erd1qqqqqqqqqqqqqpgq7wrvrhycycg28afa94hpnupgt4ae9572uugqkzc890" 
